...
function resolvePayplug4xPrelevementDeciplus(product = {}, order = {}) {
  ...
  if (
    ...
    return {
      deciplus_product_name: 'ENFANTS 250€ 4x SANS FRAIS',
      deciplus_product_search: 'enfants 250 4x',
      amount: 250,
    };
  }
...
function isPayplug4xPrelevementOrder(order = {}) {
  ...
  return isPayplug4xPrelevement(
    order.payment_plan || payment.payment_plan,
    order.billing_plan || payment.billing_plan
  );
}
