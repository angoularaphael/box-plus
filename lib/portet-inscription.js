...
const { isChildOfferProduct, isNoblartPaypalOfferProduct } = require('./billing-plan');
...
function isPortetNoblartPaypalFlow(gym, product) {
  return isPortetGym(gym) && isNoblartPaypalOfferProduct(product);
}
