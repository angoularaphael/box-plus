  ...
  <table style="width:100%;border-collapse:collapse;margin:20px 0">
    ...
    ${
      order.addons?.blade?.status === 'paid'
        ? `<tr><td style="padding:8px;border-bottom:1px solid #eee"><strong>Gants Blade 14oz</strong></td><td style="padding:8px;border-bottom:1px solid #eee">17,90 € — retrait Minimes le jour même (12h–14h et 17h–21h15, sam. 15h–18h)</td></tr>`
        : ''
    }
  </table>
  <p><strong>Pour bien démarrer :</strong></p>
