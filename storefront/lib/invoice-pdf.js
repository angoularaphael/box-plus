...
function renderInscriptionInvoice(doc, order) {
  ...
  if (addonPaid) {
    conditions.push({
      label: 'Retrait gants',
      value: 'Minimes — possibilité de retrait dès le jour même (12h–14h / 17h–21h, sam. 15h–18h)',
    });
  }
