/**
 * Validation IBAN FR (miroir de lib/iban.js — garder synchronisé).
 */
(function (global) {
  ...
  global.normalizeIban = normalizeIban;
  global.frenchIbanError = frenchIbanError;
  global.isValidFrenchIban = isValidFrenchIban;
