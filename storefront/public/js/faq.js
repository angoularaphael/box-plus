(function () {
  const FAQ_ITEMS = [
    ...
    { id: 'experience', q: 'Dois-je avoir déjà pratiqué la boxe ?', a: 'Pas du tout. La majorité de nos nouveaux adhérents découvrent la boxe chez nous. La séance d\'essai à 10 € est idéale pour faire vos premiers pas.' },
    ...
    { id: 'formule', q: 'Quelle formule choisir pour commencer ?', a: 'Pour la flexibilité : le prélèvement sans engagement. Pour économiser sur 12 mois : 259 €. Pour votre enfant : Baby Boxe ou Boxe éducative.' },
    { id: 'essai', q: 'Comment fonctionne la séance d\'essai ?', a: 'Adultes : 10 € en ligne, vous choisissez la salle et l’activité. Pas de créneau à réserver : présentez-vous 5 minutes avant le début du cours. Pour un enfant, la séance d’essai est offerte.' },
    { id: 'prelevement', q: 'Comment fonctionne le paiement par prélèvement ?', a: 'Vous payez la première échéance par carte bancaire, puis indiquez vos coordonnées bancaires pour les échéances suivantes. La formule est sans engagement — renouvelable toutes les 4 semaines.' },
    { id: 'cb-recurrent', q: 'Puis-je payer toutes les 4 semaines par carte ?', a: 'Oui, sur les formules sans engagement vous pouvez régler la première échéance par carte ou PayPal, puis les suivantes par prélèvement sans engagement. Simple, flexible, sans engagement longue durée.' },
    { id: 'resiliation', q: 'Puis-je résilier une formule sans engagement ?', a: 'Oui, les formules sans engagement peuvent être résiliées selon les conditions prévues au contrat. Contactez votre salle pour les démarches, ou utilisez David (assistant résiliation) sur la boutique pour lancer votre demande en ligne.' },
    ...
    { id: 'enfant', q: 'Mon enfant peut-il s\'inscrire ?', a: 'Oui ! Baby Boxe accueille les 3-6 ans et la Boxe éducative les 7-16 ans. L\'encadrement est adapté à chaque tranche d\'âge. La séance d’essai est offerte pour les enfants : pas de créneau à réserver, venez 5 minutes avant le début du cours.' },
  ];
