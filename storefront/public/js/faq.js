(function () {
  const FAQ_ITEMS = [
    ...
    { id: 'cb-recurrent', q: 'Puis-je payer toutes les 4 semaines par carte ?', a: 'Oui, sur les formules sans engagement vous pouvez régler la première échéance par carte ou PayPal, puis les suivantes par prélèvement automatique. Simple, flexible, sans engagement longue durée.' },
