(function () {
  const FAQ_ITEMS = [
    ...
    { id: 'formule', q: 'Quelle formule choisir pour commencer ?', a: 'Pour tester : la séance d\'essai gratuite. Pour la flexibilité : le prélèvement sans engagement. Pour économiser : le comptant 3, 6 ou 12 mois. Pour votre enfant : Baby Boxe ou Boxe éducative.' },
    { id: 'essai', q: 'Comment fonctionne la séance d\'essai ?', a: 'Réservez en ligne gratuitement. Un coach vous accueille, vous explique le déroulé et vous participez à un cours adapté aux débutants. Aucun matériel spécifique n\'est requis pour commencer.' },
